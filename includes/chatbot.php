...
(function() {
    var knowledge = {
        ...
        "create test": "To create a test:<br>1. Go to <strong>Tests</strong> in the sidebar<br>2. Click <strong>Create New Test</strong><br>3. Enter title, class, subject, and duration<br>4. Set total marks and difficulty<br>5. Click <strong>Save</strong>, then <strong>Add Questions</strong><br>6. Add MCQ and/or subjective questions with marks",
