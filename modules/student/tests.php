    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-6 hover:shadow-md transition">
            ...
            <div class="text-xs text-gray-500 space-y-1">
                ...
                <div><i class="fas fa-clock w-4 mr-1"></i> <?= $t['duration_minutes'] ?> minutes | <?= $t['total_marks'] ?> marks<?= !empty($t['shuffle_questions']) ? ' | <i class="fas fa-random text-purple-500 mr-1"></i> Shuffled' : '' ?></div>
            </div>
